# -*- coding: utf-8 -*-
"""
Created on Tue Feb 23 21:01:51 2021
...
class SchNetspec(torch.nn.Module):
    ...
    def __init__(self, hidden_channels=128, num_filters=128,
                 num_interactions=6, num_gaussians=50, cutoff=10.0,a_emb=20,
                 readout='add', dipole=False, mean=None, std=None,
                 atomref=None):
        super(SchNetspec, self).__init__()
        ...
        self.embedding = Embedding(a_emb, hidden_channels)
        ...
        self.lin2 = Linear(hidden_channels,300)
